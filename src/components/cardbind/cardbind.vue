        ...
        <div class="tab1">
          ...
          <div class="partsFoot">
            ...
            <div style="margin: 11px 2px;float: right">
              <input class="sureAble" value="提交"  type="button" @click="bandCardInfoSubmit()"  v-show="!isUnbind">
              <input class="sureAble" value="提交解绑" type="button" @click="bandCardInfoUnbind()" v-show="isUnbind">
              <input class="sureAble"  value="一键解绑" type="button" @click="bandCardUnbindAll()" v-show="isUnbind">
